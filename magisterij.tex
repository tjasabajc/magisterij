...
\newcommand{\imeavtorja}{Tjaša Bajc} % ime avtorja
\newcommand{\imementorja}{prof.~dr.~Bor Plestenjak} % akademski naziv in ime mentorja, uporabi poln naziv, prof.~dr.~, doc.~dr., ali izr.~prof.~dr.
\newcommand{\imesomentorja}{} % akademski naziv in ime somentorja, če ga imate
\newcommand{\naslovdela}{Verjetnostni singularni razcep}
\newcommand{\letnica}{2021} % letnica magistriranja
\newcommand{\opis}{Ena poved, opis dela.}  % Opis dela v eni povedi. Ne sme vsebovati matematičnih simbolov v $ $.
